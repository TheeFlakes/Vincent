                    ...
                    <div class="flex gap-3">
                        ...
                        {:else}
                            ...
                            <button 
                                ...
                                class="px-6 py-3 bg-[#C392EC] text-white rounded-lg font-medium hover:bg-[#C392EC]/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                            >
